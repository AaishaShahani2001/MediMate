...
export default function Navbar() {
  ...
  const activeClass = ({ isActive }) =>
    isActive ? `${linkBase} text-blue-700 bg-blue-50` : `${linkBase} text-slate-700`;
    ...
    <header className="sticky top-0 z-30 border-b bg-white/90 backdrop-blur">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 md:py-4">
        ...
        <div className="hidden items-center gap-2 md:flex">
          <Link to="/login" className="px-3 py-2 text-sm font-medium text-slate-700 hover:text-blue-700">
            Login
          </Link>
          <Link
            to="/signup"
